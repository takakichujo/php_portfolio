...
$dbh = new PDO($dsn,$user,$pass,[
    ...
    $sql = 'update testlist set name = :name , age = :age , mail= :mail ,prefecture_no=:prefecture_no , prefecture_name=:prefecture_name ,prefecture_kana=:prefecture_kana where id= :id' ;
